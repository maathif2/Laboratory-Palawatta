                ...
                <div className="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <a class="brand" href="index.html">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBkpIblaUyIW_VAlKG-BM_s8Me-wh7FiOkWA&usqp=CAU" style={{ width: '75px' }} alt="image" />
                        </a>
                        <ul class="navbar-nav m-auto">
                            <li class="nav-item active"><Link to="/home" class="nav-link">Home</Link></li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Support Services</a>
                            ...
                            <li class="nav-item" onClick={handleLogout}></li>
                        ...
                        <div><a href="" className="btn btn-def" onClick={handleLogout}>{user && "Log out"}</a></div>
                    </div>
                </div>
            </nav>
        </div>
