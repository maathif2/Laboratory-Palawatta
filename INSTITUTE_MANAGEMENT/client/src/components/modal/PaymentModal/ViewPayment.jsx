...
export default function ViewPayment(props) {
  ...
  axios.get(`http://localhost:5000/api/payments/`+props.paymentId).then(function(response) {
    ...
    console.log(error);
    swal(" Invalid Payment ID !","Please enter A Valid ID !", "error");
  });
  ...
  function submitForm(e){
    ...
    axios.get(`http://localhost:5000/api/payments/`+props.paymentId,ViewData)
  ...
  <Form.Group as={Row} className="mb-3 " controlId="formPlaintextEmail">
    ...
    <Col sm={10}>
      <Form.Control type="text" value={employment_type} disabled/>
    </Col>
