      ...
      <div className="row">
        ...
        <h1>Schedule a class</h1><br /> 
          ...
          <div className="mb-3">
              ...
              <select className="form-select" aria-label="Default select example" onChange={(e)=>{setDay(e.target.value)}}>
            ...
            <div className="mb-3">
              ...
              <input type="time" id="inputTime" className="form-control" placeholder="08.30-10.30" onChange={(e)=>{setsTime(e.target.value)}} required/>
            </div>
            <div className="mb-3">
              <label for="time" className="form-label">To</label>
              <input type="time" id="inputTime" className="form-control" placeholder="08.30-10.30" onChange={(e)=>{seteTime(e.target.value)}} required/>
            </div>

            <div className="mb-3">
              <label for="grade" className="form-label">Grade</label>
              <select className="form-select" aria-label="Default select example" onChange={(e)=>{setGrade(e.target.value)}}>
            ...
            <div className="mb-3">
              ...
              <select className="form-select" aria-label="Default select example" onChange={(e)=>{setTeacher(e.target.value)}}>
            ...
            <div className="mb-3">
              ...
              <select className="form-select" aria-label="Default select example" onChange={(e)=>{setHallNo(e.target.value)}}>
